...
if (document.inputNombre.value.length==0){
    alert("Tiene que escribir su nombre")
    document.inputNombre.focus()
    return 0;
}

//valido el Presupuesto
if (document.inputPresupuesto.selectedIndex==0){
...
const email = document.getElementById("inputEmail");
    ...
    email.setCustomValidity("Debes escribir tu email");
  } else {
    email.setCustomValidity("");
  }
});

function diasdeviaje() {
    if(dias >2 && dias <=5){
...
let nombre = prompt ('Ingrese su nombre');
    ...
    //var esnombre = document.getElementById("inputNombre").value;
    //console.log( dias.innerHTML );
